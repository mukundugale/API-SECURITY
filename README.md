...
| # | Vulnerability                            | Status    | Documentation                                |
| - | ---------------------------------------- | --------- | -------------------------------------------- |
| 1 | JWT None Algorithm Attack                | Completed | [View Finding](./JWT-None-Algorithm-Attack/) |
| 2 | Mass Assignment                          | Planned   | Coming Soon                                  |
| 3 | Excessive Data Exposure                  | Planned   | Coming Soon                                  |
| 4 | Broken Object Level Authorization (BOLA) | Planned   | Coming Soon                                  |
| 5 | API Security Misconfiguration            | Planned   | Coming Soon                                  |
